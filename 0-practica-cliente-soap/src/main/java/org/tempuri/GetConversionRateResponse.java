...
public class GetConversionRateResponse {
    ...
    @XmlElement(name = "GetConversionRateResult", required = true)
    protected BigDecimal getConversionRateResult;

    /**
     * Obtiene el valor de la propiedad getConversionRateResult.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
    ...
    /**
     * Define el valor de la propiedad getConversionRateResult.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
